...
export class HttpError {
    ...
    private constructor(public readonly code: string, public readonly message: string, public readonly stacktrace?: string[], public readonly details?: string) {
    ...
    public static forDev(code: string, message: string, stacktrace: string[], details: string): HttpError {
        return new HttpError(code, message, stacktrace, details);
    }
