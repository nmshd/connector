...
export class TokensEndpoint extends Endpoint {
    ...
    public async loadPeerToken(request: LoadPeerTokenRequest): Promise<ConnectorResponse<ConnectorToken>> {
        return await this.post("/api/v1/Tokens/Peer", request);
    }
}
